		...
		<table width="665" cellpadding="0" cellspacing="0" border="0">
			<tr>
				<td width="200" valign="top">
					<font class="section_heading">Alumni Services</font>
					<br />
					<br />
					<strong>Student Connection</strong>
						<ul>
							<li>Orientation luncheon</li>
							<li>Care Packages</li>
							<li>Student Events</li>
						</ul>
					<br />
					<br />
					<strong>Alumni Encouragement</strong>
						<ul>
							<li>Homecoming</li>
				...
				<td valign="top"><img src="../../images/alumni/alumni_wall.jpg" />
				  <br /></td>
			</tr>
		</table>
		<!-- InstanceEndEditable -->
