...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/alumni_menu_breadcrumb.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
	  ...
	  <td rowspan="2" class="content">
	  	<table border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td valign="top" rowspan="2">
					<table cellpadding="0" cellspacing="0" border="0" width="120">
						<tr>
							<td height="56"><a href="../update_your_information/">
											<img src="../../images/buttons/alumni/update_your_information.jpg" border="0"/></a></td>
						</tr>
																			<tr>
							<td height="44"><a href="../alumni_services/"><img src="../../images/buttons/alumni/alumni_services.jpg" border="0"/></a></td>
						</tr>
						<tr>
							<td height="44"><a href="../speakers_bureau/"><img src="../../images/buttons/alumni/speakers_bureau.jpg" border="0"/></a></td>
						</tr>
						<tr>
							<td height="56"><a href="../transcript/"><img src="../../images/buttons/alumni/request_transcript.jpg" border="0"/></a></td>
						</tr>
                        <tr>
                        	<td height="44"><a href="../chapel_sermons/"><img src="../../images/buttons/alumni/chapel_sermons.jpg" border="0"/></a></td>
                        </tr>
						<tr>
							<td height="20">&nbsp;</td>
						</tr>
			...
			<tr>
                ...
                <em>To listen to a sermon, simply click the Message Title. To download a sermon to your computer, right-click the Message Title and select "Save link as..." or "Save target as..."</em>
<?php
require_once('list.inc.php');
//echo "<h2>Chapel Sermons - Fall 2013</h2>";
//listSermons('fall2013');
echo "<h2>Chapel Sermons - Spring 2013</h2>";
listSermons('spring2013');
echo "<h2>Chapel Sermons - Fall 2012</h2>";
listSermons('fall2012');
?>
<br />
<br />
		<!-- InstanceEndEditable -->
