...
?><?php
// --- Valid List of Referrers

// --- Array of Form Elements ---
$form_mail[] = array( "name" => "firstname", "text" => "First Name:",  "type" => "text", "required" => "Required" ) ;
$form_mail[] = array( "name" => "lastname", "text" => "Last Name:",  "type" => "text", "required" => "Required" ) ;
...
$form_mail[] = array( "name" => "phone_number", "text" => "Phone Number:",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "date", "text" => "Early Registration Day Attending:",  "type" => "text", "required" => "Required" ) ;
...
{ 
	...
	foreach ( $hosts as $host){
		array_push($referrers,"http://$host/events/early_registration/");
		array_push($referrers,"http://$host/events/early_registration/index.php");
	}
