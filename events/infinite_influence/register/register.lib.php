<?
define( "ADMIN_MAIL", "aray@slcconline.edu" ); // bug report email
...
$form_mail[] = array( "name" => "Email", "text" => "E-mail Address:",  "type" => "sender's email", "required" => "Required" ) ;
$form_mail[] = array( "name" => "Church", "text" => "Church:",  "type" => "text", "required" => "Required" ) ;
$form_mail[] = array( "name" => "churchAddress", "text" => "Church's Address:",  "type" => "text", "required" => "Required" ) ;
$form_mail[] = array( "name" => "churchCity", "text" => "Church's City:",  "type" => "text", "required" => "Required" ) ;
$form_mail[] = array( "name" => "churchState", "text" => "Church's State:",  "type" => "text", "required" => "Required" ) ;
$form_mail[] = array( "name" => "churchZIP", "text" => "Church's ZIP:",  "type" => "text", "required" => "Required" ) ;
