...
$form_mail[] = array( "name" => "Email", "text" => "E-mail Address:",  "type" => "sender's email", "required" => "" ) ;
...
$form_mail[] = array( "name" => "Team_Name", "text" => "Team Name:", "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "Payment", "text" => "Form of Payment:", "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "Sponsorship", "text" => "Interested in Sponsoring:", "type" => "text", "required" => "Required" ) ;
$form_mail[] = array( "name" => "Donation", "text" => "Interested in Donating:", "type" => "text", "required" => "Required" ) ;
