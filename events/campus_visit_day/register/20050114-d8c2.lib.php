<?
define( "ADMIN_MAIL", "techserv@slcconline.edu" ); // bug report email
...
$path="/events/campus_visit_day/register/";
...
$form_mail[] = array( "name" => "address", "text" => "Address:",  "type" => "text", "required" => "" ) ;
...
$form_mail[] = array( "name" => "email", "text" => "E-mail:",  "type" => "sender's email", "required" => "Required" ) ;
$form_mail[] = array( "name" => "hs", "text" => "High School:",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "gradYear", "text" => "Year of Graduation:",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "church", "text" => "Home Church:",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "dateAttending", "text" => "Campus Visit Day Attending:",  "type" => "text", "required" => "Required" ) ;
$form_mail[] = array( "name" => "total", "text" => "Total Number Attending:",  "type" => "text", "required" => "" ) ;
...
if( $HTTP_POST_VARS["formmail_submit"] ){
	...
	if( ! $sErr ){
		...
		else $sErr="Invalid referrer. Referrer was:" . $_SERVER['HTTP_REFERER'];
	}
}
...
{ 
	...
	$hosts=array('contribute.oes.slcconline.edu','slcconline.edu','www.slcconline.edu');
	global $referrers;
	$referrers=array();
	foreach ( $hosts as $host){
		array_push($referrers,"http://$host/events/campus_visit_day/register/");
		array_push($referrers,"http://$host/events/campus_visit_day/register/index.php");
		array_push($referrers,"https://$host/events/campus_visit_day/register/");
		array_push($referrers,"https://$host/events/campus_visit_day/register/index.php");
	}
