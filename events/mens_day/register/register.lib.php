<?
  define( "ADMIN_MAIL", "evoris@slcconline.edu" ); // bug report email
...
?><?php 
  ...
  $form_mail[] = array( "name" => "churchAddress", "text" => "Church Address:", "type" => "text", "required" => "" ) ;
  $form_mail[] = array( "name" => "churchCity", "text" => "Church City:", "type" => "text", "required" => "" ) ;
  $form_mail[] = array( "name" => "churchState", "text" => "Church State:", "type" => "text", "required" => "" ) ;
  $form_mail[] = array( "name" => "churchZIP", "text" => "Church ZIP:", "type" => "text", "required" => "" ) ;
