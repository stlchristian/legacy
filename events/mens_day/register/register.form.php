...
<?php
 ...
 ?>
                      ...
                      <form name="frmFormMail" action="" method='post' enctype='multipart/form-data'>
                          ...
                          <input type='hidden' name='esh_formmail_subject' value="Men's Day Registration">
                          ...
                          <input type='hidden' name='esh_formmail_return_subject' value="[SLCC Men's Day] Thank You for Your Registration!">
                          <input type='hidden' name='esh_formmail_return_msg' value="This email is sent to confirm that we have received your SLCC Men's Day Registration. Again, please note that this does not indicate that your registration fee has been paid. All registrations will be paid at the door.
...
-Saint Louis Christian College">
                        ...
                        <table border='0' cellpadding='3' cellspacing='0' bgcolor="#FFFFFF" class="form"  >
                          <tr>
                            <td width="125" rowspan="14" align="right" valign="bottom" class="sidebar">&nbsp;</td>
                            <td width="165" valign="top" class="sidebar"><div align="right">Name :</div></td>
                            <td width="161" valign="top" class="form_text"><input name="Full_Name" type="text" class="box" id="Full_Name" size="15"></td>
                            <td width="575" rowspan="14" valign="top" class="form_text">
                              <h3> Men's Day Registration</h3>
                              <p class="sidebar"> We would love for you to
                                complete this short, online form in order to
                                register for the SLCC Men's Day Conference. </p>
                            ...
                            below.</em></p>
                              ...
                              <center>
                              	<a target="_blank" href="poster.pdf"><img src="poster.jpg" /></a><br /><br />
                              </center>
                            </td>
                          </tr>
                          <tr>
			      ...
			      <OPTION VALUE=WY> Wyoming</OPTION>
                          ...
                          <tr>
                            ...
                            <td valign="top" class="form_text"><input name="Email" type="text" class="box" id="Email" size="15">                            </td>
                          </tr>
						  <tr>
                          ...
                          <tr>
                            <td width="165" height="30" align='right' valign='top' class="sidebar"><div align="right" class="style7">Church's State: </div></td>
			      ...
			      <OPTION VALUE=WY> Wyoming</OPTION>
                          ...
                          <tr>
                            ...
                            <td valign="top" class="form_text">
                            	<input name="churchZIP" type="text" class="box" size="5" maxlength="10">
                                <input type="hidden" name="downwithbots" value="" />
                            </td>
                          </tr>
                          <tr>
                          	<td width="165"></td>
