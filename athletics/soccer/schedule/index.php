...
day = new Date();
id = day.getTime();
eval("page" + id + " = window.open(URL, '" + id + "', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=0,width=700,height=500,left = 230,top = 180');");
}
</script>
<style type="text/css">
<!--
	  ...
	  <td rowspan="2" class="content">
	  	<table border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<p align="center" class="style1"><?php echo date("Y"); ?> Season</p>
				<p>
				  <?php 
						  include ( "../../includes/functions.php" );
						  schedule ("soc"); ?>
				  </p>
				<P><i>Home games for the <?php echo date("Y"); ?> season will be played at the Eagan Center (about 1 mile north of SLCC). From Dunn Rd, take Waterford Dr (the road just west of SLCC) about 1 mile and field is on the right. Address for the Eagan Center is: 1 James J. Eagan Dr, Florissant, MO 63033</i></P>
				<!-- InstanceEndEditable -->
							</td>
						</tr>
					</table>
