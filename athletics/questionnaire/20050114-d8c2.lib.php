...
$form_mail[] = array( "name" => "Address_(Line_2)", "text" => "Address (Line 2):",  "type" => "text", "required" => "" ) ;
...
$form_mail[] = array( "name" => "Country", "text" => "Country:",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "ZIP", "text" => "ZIP:",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "HPhone", "text" => "Home Phone Number:",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "CPhone", "text" => "Cell Phone Number:",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "E-mail_Address", "text" => "E-mail Address:",  "type" => "sender's email", "required" => "Required" ) ;
$form_mail[] = array( "name" => "Birthdate", "text" => "Birthdate:",  "type" => "text", "required" => "Required" ) ;
$form_mail[] = array( "name" => "Gender", "text" => "Gender:", "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "Church", "text" => "Church Attending:",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "Parents", "text" => "Parent Name(s):",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "Degree", "text" => "Degree:", "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "highschool", "text" => "High School Attended:",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "gpa", "text" => "GPA:",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "satscore", "text" => "SAT Score:",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "actscore", "text" => "ACT Score:",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "hs_graduation", "text" => "Year of High School Graduation:",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "juniorcollege", "text" => "Junior College Attended:",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "gpa_juco", "text" => "GPA Juco:",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "credits_juco", "text" => "Credits Juco:",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "othercollege", "text" => "Other College Attended:",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "gpa_other", "text" => "GPA Other:",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "credits_other", "text" => "Credits Other:",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "sport_interest", "text" => "Sport of Interest:",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "positions_played", "text" => "Positions Played:",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "height", "text" => "Height:",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "weight", "text" => "Weight:",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "coach_name", "text" => "Coach Name:",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "coach_phone_number", "text" => "Coach Phone Number:",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "years_played", "text" => "Number of Years Played:",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "comments", "text" => "Comments/Additional Information:",  "type" => "text", "required" => "" ) ;
