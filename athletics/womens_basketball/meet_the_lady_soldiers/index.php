<?php include ( $_SERVER['DOCUMENT_ROOT'] . "/athletics/includes/athletics_season.php" ); ?>
	  	...
	  	<table border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<table border="0" cellpadding="2" cellspacing="0" width="533">
					<tr>
						<td colspan="6">
  						  <p align="center" class="style1"><center><h2><?php echo bball_season(); ?> Lady Soldiers</h2></center></p>
						</td>
					</tr>
					<?php wbasRoster();?>
				</table>
