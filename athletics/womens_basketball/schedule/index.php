...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/athletics_womens_basketballl_menu_breadcrumb.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
	  ...
	  <td rowspan="2" class="content">
	  	<table border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
					...
					<table width="142" cellpadding="0" cellspacing="0" border="0" class="table_valign_content">
						...
						<tr>
							...
							<td width="110"><center>
								...
								<br />
								<br />
								<a href="../meet_the_lady_soldiers/"><b>Meet The<br />Lady Soldiers</b></a>
								<br />
								<br />
                ...
                <?php include("../../includes/athletics_season.php"); ?>
				<p align="center" class="style1"><center><h2><?php echo bball_season(); ?> Season</h2></center></p>
				<p>
				<?php include ( "../../includes/functions.php" ); schedule ("wbas"); ?>
				</p>
				<!-- InstanceEndEditable -->
							</td>
						</tr>
