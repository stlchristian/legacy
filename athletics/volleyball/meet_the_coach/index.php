	  	...
	  	<table border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<table width="533" cellpadding="0" cellspacing="0" border="0">
					<tr>
					  <td>
							<b>Name:</b><!-- Adrienne Linville-->
							<br />
							<br />
							<b>Contact Information:</b><!-- <a href="javascript:linkTo_UnCryptMailto('nbjmup;bmjowjmmfAtmddpomjof/fev');">alinville [at] slcconline [dot] edu</a>-->
                       </td>
					</tr>
				</table>
							<!-- InstanceEndEditable -->
