<?php include ("../../../includes/athleticsRoster.inc.php");?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/athletics_volleyball_menu_breadcrumb.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
	...
	<tr>
	  ...
	  <td rowspan="2" class="content">
	  	<table border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td valign="top">
					<table width="142" height="100%" cellpadding="0" cellspacing="0" border="0" class="table_valign_content">
						<tr>
				...
				<table border="0" cellpadding="2" cellspacing="0" width="533">
					<tr>
						<td colspan="6">
					      <!--<div align="center"><img src="09-10vb.JPG" width="550" height="356">-->
			            </div></td>
					</tr>
					<tr>
						<td colspan="6">
							<center>
							  <font class="section_heading"><?php echo date("Y"); ?> Lady Soldiers</font>
							</center>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="2"><div align="center"><b>Pos.</b></div></td>
						<td><div align="center"><b>Hometown</b></div></td>
						<td><div align="center"><b>Year</b></div></td>
					</tr>
					<tr>
						<td colspan="6">&nbsp;</td>
					</tr>
					<?php volleyballRoster();?>
				</table>
				<br />
				<!-- InstanceEndEditable -->
							</td>
