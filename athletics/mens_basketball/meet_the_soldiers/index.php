...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/athletics_mensbasketball_menu_breadcrumb.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
			...
			<tr>
				...
				<table border="0" cellpadding="2" cellspacing="0" width="533">
					<tr>
						<td colspan="6">
						  <center>
						    <p><font class="section_heading"><?php echo bball_season(); ?> Soldiers</font></p>
						  </center>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><div align="center"><b>Height</b></div></td>
