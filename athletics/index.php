	...
	<tr>
	  ...
	  <td rowspan="2" class="content">
		...
		<table width="665" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td class="athletics_main" style="background-position: top;">
					<table width="665" height="500" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td valign="top">
								<table width="325" border="0" cellpadding="0" cellspacing="0">
									...
									<tr>
									  <td>
                                      	<p><em>St. Louis Christian College is a member of the following athletics organizations:</em></p>
                                        <img src="../images/logos/acca.jpg" />
                                      </td>
									</tr>
								</table>
							</td>
