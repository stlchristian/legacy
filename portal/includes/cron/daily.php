...
$errormail="webmaster@example.com";
class email{
	var $headers="From: donotreply@slcconline.edu\r\nContent-type: text/html\r\n";
	var $body1="<html><head></head><body>SLCCOnline.edu, the website of Saint Louis Christian College is currently listing a ministry opportunity for a ";
	var $body2=".<br>\nYour email address was given as a point of contact.<br>\nThis listing is set to expire in ";
	var $body3=" day(s)<br><a href='http://1.2.3.4/minopps/email_response.php?id=";
	var $body4="&action=1'>Click Here to Renew this Listing</a><br>\n<a href='http://172.31.0.15/minopps/email_response.php?id=";
...
$interval=73;
connect();
$query1="SELECT * FROM minopps_database WHERE ADDDATE(post_date,INTERVAL $interval DAY)=curdate()";
