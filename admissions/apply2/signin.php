	  	...
	  	<table border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
                ...
                <div style="float:left;">
                	<p>Sign up to access the online application</p>
                    <form name="signup" action="signin.php" method="post">
                ...
                <div align="right" style="float:right;">
                	<p>Continue an existing application:</p>
                ...
                <?php
					...
					if (isset($_POST)) {
						...
						// Did the user submit the login form? -- This needs to be in 'landing.php', not here
						if (isset($_POST['login'])) {
							//echo 'Logging in';
						}
						
						// Did the user submit the signup form?
						if (isset($_POST['signup'])) {
							//echo 'Signing up';
							// function courtesy of $Pr07o7yp3 on StackOverflow
							function generateRandomString($length = 10) {    
								return substr(str_shuffle("0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"), 0, $length);
							}
							$salt = sha256(generateRandomString(20) . strtolower($_POST['email']));
							echo $salt;
						}
