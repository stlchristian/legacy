...
<script type="text/javascript">
	jQuery(function($){
		$("#ged_date").mask("99/99/9999");
		$("#act_date").mask("99/9999");
		$("#sat_date").mask("99/9999");
		$("#c1_dates").mask("99/9999-99/9999");
		$("#c2_dates").mask("99/9999-99/9999");
		$("#c3_dates").mask("99/9999-99/9999");
	});
</script>
<!-- InstanceEndEditable -->
</head>
	  ...
	  <td rowspan="2" class="content">
	  	<table border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
                ...
                <!-- Voldemort -->
                <?php
					include('includes/app_forms/educational_info.html');
					mysql_close();
				?>
				<!-- InstanceEndEditable -->
							</td>
