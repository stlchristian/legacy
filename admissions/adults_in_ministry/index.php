...
<title>Adults In Ministry | Saint Louis Christian College</title>
<!-- InstanceEndEditable -->
		...
		<table border="0" cellpadding="0" cellspacing="0" width="533">
				<tr valign="top">
				  <td width="290" valign="top">
						<span class="style1">Adults In Ministry (AIM) </span>					  <br />
						<br />
						The Adults In Ministry program is designed for  adults either coming to college for the first time or returning to complete a  degree. This program offers the flexibility of working full-time during the day  and attending classes in the evening. Take a look at what we have to offer.  This may just be the program you have been looking for.</td>
					<td width="10">&nbsp;</td>
					<td width="233" valign="middle"><img src="../../images/admissions/aim.jpg" border="0" /></td>
				</tr>
			</table>
			<!-- InstanceEndEditable -->
							</td>
