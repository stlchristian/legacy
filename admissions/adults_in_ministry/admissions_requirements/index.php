...
<title>Admissions Requirements | Saint Louis Christian College</title>
<!-- InstanceEndEditable -->
	  ...
	  <td rowspan="2" class="content">
		  <table width="795" border="0" cellpadding="0" cellspacing="0" class="table_valign_content">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="533">
				<tr>
					<td><p>Non-traditional students must be at least 20 years of age to be admitted  into the Adults in Ministry Associate of Applied Science program. You must be  at least 23 years of age to be considered for the Adults in Ministry Bachelor  of Science program. </p></td>
				</tr>
				<tr>
					<td height="15"><img src="../../../images/grayline_contentdivider.jpg" width="533"/></td>
				</tr>
				<tr>
					<td>
						<b>Requirements For Acceptance</b>
						<ul>
							<li>Application</li>
							<li>$25 Application Fee</li>
							<li>Church Reference</li>
							<li>ACT/SAT (not required for students older than 23)</li>
							<li>High School Transcript- (at least 6-semester)</li>
							<li>College Transcript(s) (taken during High School)</li>
							<li>Good Standing Form(s) (for all colleges attended in past 5 years)</li>
						</ul>
						<b>Requirements prior to enrollment</b>
						<ul>
							<li>Completed College Transcript(s)</li>
							<li>Health Form</li>
							<li>Housing Form</li>
							<li>Reservation and Orientation Fee ($250 non-refundable)</li>
						</ul>
					</td>
				</tr>
			</table>
