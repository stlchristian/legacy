...
<title>Request More Information | Saint Louis Christian College</title>
<!-- InstanceEndEditable -->
	...
	<tr>
	  ...
	  <td rowspan="2" class="content">
		  <table width="795" border="0" cellpadding="0" cellspacing="0" class="table_valign_content">
			...
			?>
			<?php include("../../includes/request_more_information.inc"); ?>
			...
			<p>
				<?php
					...
					print( "<br><br><hr><center><b>Your form has been sent. Thank you.</b></center><br><br>" );
					endif; //!$isHideForm
				?>
			</p>
		<!-- InstanceEndEditable -->
