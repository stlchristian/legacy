	...
	<tr>
	  ...
	  <td rowspan="2" class="content">
		  <table width="795" border="0" cellpadding="0" cellspacing="0" class="table_valign_content">
			...
			<table border="0" cellpadding="0" cellspacing="0" class="table_valign_content" width="533">
				<tr>
				  <td width="290" valign="top">
						<font class="section_heading">Freshman</font>
						<br />
						<br />
						High school is coming to an end and you have a  big decision to make. We want to help you in any way we can as you make this  decision. Take a look at what Saint    Louis Christian College has to offer. You may just  discover that SLCC is where you belong. </td>
					<td width="10">&nbsp;</td>
					<td width="233" valign="middle" height="300"><div align="center"><img src="../../images/admissions/amy.jpg" border="0" /></div></td>
				</tr>
			</table>
		<!-- InstanceEndEditable -->
							</td>
