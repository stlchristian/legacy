...
$form_mail[] = array( "name" => "Year_of_High_School_Graduation", "text" => "Year_of_High_School_Graduation",  "type" => "text", "required" => "required" ) ;
$form_mail[] = array( "name" => "prospective_term", "text" => "prospective_term", "type" => "text", "required" => "Required" ) ;
$form_mail[] = array( "name" => "prospective_year", "text" => "prospective_year", "type" => "text", "required" => "Required" ) ;
...
$form_mail[] = array( "name" => "E-mail_Address", "text" => "E-mail_Address",  "type" => "text", "required" => "Required" ) ;
...
$form_mail[] = array( "name" => "Church", "text" => "Church",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "Please_send_info_about0", "text" => "Please_send_info_about0",  "type" => "checkbox", "required" => "" ) ;
$form_mail[] = array( "name" => "Please_send_info_about1", "text" => "Please_send_info_about1",  "type" => "checkbox", "required" => "" ) ;
$form_mail[] = array( "name" => "Area_of_Inquiry", "text" => "Area_of_Inquiry",  "type" => "checkbox", "required" => "" ) ;
$form_mail[] = array( "name" => "Area_of_Inquiry0", "text" => "Area_of_Inquiry0",  "type" => "checkbox", "required" => "" ) ;
$form_mail[] = array( "name" => "Area_of_Inquiry1", "text" => "Area_of_Inquiry1",  "type" => "checkbox", "required" => "" ) ;
$form_mail[] = array( "name" => "Area_of_Inquiry2", "text" => "Area_of_Inquiry2",  "type" => "checkbox", "required" => "" ) ;
$form_mail[] = array( "name" => "Area_of_Inquiry3", "text" => "Area_of_Inquiry3",  "type" => "checkbox", "required" => "" ) ;
$form_mail[] = array( "name" => "First_Choice", "text" => "First_Choice",  "type" => "select", "required" => "" ) ;
$form_mail[] = array( "name" => "Second_Choice", "text" => "Second_Choice",  "type" => "select", "required" => "" ) ;
$form_mail[] = array( "name" => "previous", "text" => "previous", "type" => "select", "required" => "Required" ) ;
$form_mail[] = array( "name" => "hours", "text" => "hours", "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "hearabout", "text" => "hearabout",  "type" => "select", "required" => "Required" ) ;
$form_mail[] = array( "name" => "comments", "text" => "comments",  "type" => "select", "required" => "" ) ;
