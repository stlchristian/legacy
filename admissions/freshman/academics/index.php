	...
	<tr>
	  ...
	  <td rowspan="2" class="content">
		...
		<table border="0" cellpadding="0" cellspacing="0" width="533">
          <tr>
            <td valign="top"><font class="section_heading">Degree Programs</font> <br />
              Saint Louis Christian College is a four-year Bible College that offers a variety of degree programs. <br />
              <br />
              <a href="degree_programs/"> <strong>Click here to view Saint Louis Christian College's Degree Programs.</strong> </a> </td>
            <td width="10" rowspan="3">&nbsp;</td>
            <td rowspan="3" valign="top">
				<?php include("../../../includes/catalog.inc"); ?>
                <br />
				<?php include("../../includes/class_schedules.inc"); ?>
			  </td>
          </tr>
          <tr>
            <td valign="middle" height="25"><img src="../../../images/grayline_contentdivider.jpg" width="333" /> </td>
          </tr>
          <tr>
            <td valign="top"><?php include("../../includes/academics.inc"); ?>
              <a href="partnership_programs/"> <strong> Click here to view the partnership programs Saint Louis Christian College has with other universities. </strong> </a> </td>
          </tr>
		  </table>
		<!-- InstanceEndEditable -->
							</td>
