	  ...
	  <td rowspan="2" class="content">
		  <table width="795" border="0" cellpadding="0" cellspacing="0" class="table_valign_content">
			...
			<tr>
				...
				<tr>
					<td>
						At SLCC, we realize the admissions process can be complicated. We strive to assist you every step of the way. The chart below illustrates the steps necessary to complete your enrollment and prepare for your future at SLCC.
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						...
						<ul>
                            ...
                            <li>Education/Employer Reference</li>
							...
							<li>Good Standing Form(s) (for all colleges attended in past five years)</li>
						</ul>
						<b>Requirements prior to enrollment</b>
						<ul>
							<li>Completed High School Transcripts</li>
