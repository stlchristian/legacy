	  ...
	  <td rowspan="2" class="content">
	  	<table border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<!-- This is the new online application, designed and coded by Elliot John Voris -->
                <!-- Voldemort -->
                <table border="0" cellpadding="0" cellspacing="0" width="665">
					<tr>
						<td>
							...
							<br />
							<br />
							<a href="apply_online.php">Click <strong>here</strong> to begin the online application process.</a>
						</td>
					</tr>
					<tr>
						<td height="25">
					...
					<tr>
						<td width="310" valign="top">
							...
							<ul>
								...
								<li><a href="printable_forms/fin_aid_app.pdf">Financial Aid Application Form</a></li>
                            ...
                            <ul>
                                <li><a href="printable_forms/soldier_scholarship.pdf" target="_blank">Soldier Scholarship Application</a></li>
                                <li><a href="printable_forms/institutional_scholarships.pdf" target="_blank">List of Institutional Scholarships</a></li>
                            </ul>
						</td>
					</tr>
					<tr>
