	  ...
	  <td rowspan="2" class="content">
		...
		<table cellpadding="2" cellspacing="2" border="0" width="660">
			...
			<tr>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;Cell Phone:&nbsp;&nbsp;&nbsp;&nbsp;<input name="cell" id="cell" type="text" width="50" vale="<?php echo $cell;?>"/></td>
            </tr>
            <tr>
            	<td></td>
                <td>&nbsp;</td>
			...
			<tr>
				...
				<td>
					...
					<input name="marital_status" id="marry4" type="radio" value="divorced_separated" <?php echo ($_POST['marital_status'] == 'divorced_separated')? 'checked': ''?>/>Divorced/Separated
					<br />
