	  	...
	  	<table border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="665">
					<tr>
						<td>
							<font class="section_heading">Apply Online</font>
							<br />
							<br />
							<a href="page1.php">Click <strong>here</strong> to complete your SLCC application online.</a>
                            <!--Thank you for your interest in Saint Louis Christian College. At this time we are in the process of updating our new online application. We hope to have this up and running very soon. In the meantime please feel free to print off the attached application and either email, fax or mail it to us.
                            <br /><br />
                            SLCC Office of Admissions<br />
							1360 Grandview Drive<br />
							Florissant, Missouri 63033<br />
							admissions@slcconline.edu<br />
							Fax: 314.837.8291<br />
							<br />
							Thank you for your patience as we make this transition.<br />
							<br />
							Carrie Chapman<br />
					...
					<tr>
						<td height="25">
							<img src="../../images/grayline_contentdivider.jpg" width="665" />
						</td>
					</tr>
					<tr>
						<td>
							<font class="section_heading">Downloadable Application & Forms</font>
							<br />
						</td>
					</tr>
					<tr>
						<td width="310" valign="top">
							<strong>Downloadable Application</strong>
							<ul>
								<li><a href="printable_forms/printable_slcc_application3.pdf">SLCC Application for Admission</a></li>
                                <li><a href="printable_forms/essay.pdf">Essay Questions</a></li>
							</ul>
							<strong>Downloadable Forms</strong>
							<ul>
								<li><a href="printable_forms/application_checklist.pdf">Application Checklist</a></li>
								<li><a href="printable_forms/churchref.pdf">Church Reference Form</a></li>
                                <li><a href="printable_forms/employer_reference.pdf">Education/Employer Reference Form</a></li>
								<li><a href="printable_forms/college_trans.pdf">College Transcript Form</a></li>
								<li><a href="printable_forms/good_stand_ref_form.pdf">Good Standing Reference Form</a></li>
								<li><a href="printable_forms/hs_trans.pdf">High School Transcript Form</a></li>
							    <li><a href="printable_forms/housing_form_pg1.pdf" target="_blank">Housing Form (Page 1)</a></li>
							    <li><a href="printable_forms/housing_form_pg2.pdf" target="_blank">Housing Form (Page 2)</a></li>
							    <li><a href="printable_forms/health_form_pg1.pdf" target="_blank">Health Form (Page 1)</a></li>
							    <li><a href="printable_forms/health_form_pg2.pdf" target="_blank">Health Form (Page 2)   </a></li>
							</ul>
                            <strong>Forms for International Students</strong>
                            <ul>
                            	<li><a href="printable_forms/international_application.pdf" target="_blank">International Application</a></li>
                            </ul>
                            <strong>Scholarship Forms</strong>
                            <ul>
                                <li><a href="printable_forms/soldier_scholarship_application.pdf" target="_blank">Soldier Scholarship Application</a></li>
                                <li><a href="printable_forms/soldier_scholarship_reference_form.pdf" target="_blank">Soldier Scholarship Reference Form</a></li>
                            </ul>
						</td>
					</tr>
					<tr>
