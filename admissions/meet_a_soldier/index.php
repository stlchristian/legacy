	...
	<tr>
	  ...
	  <td rowspan="2" class="content">
		...
		<table width="665" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td colspan="7">
					<font class="section_heading">Meet A Soldier</font>
					<br />
					<br />
					SLCC would like to introduce to you a few of our Soldiers.  Below are a mixture of profiles of current students, professors, staff, and alumni so that you may get to know SLCC's Soldiers on a more personal level.
					<br />
				</td>
			</tr>
			<tr height="25">
			...
			<tr>
				<td colspan="5">
					<center><font class="section_heading">Current Students</font></center>
				</td>
			</tr>
			<tr align="center" valign="top">
						...
						<table cellpadding="0" border="0" cellspacing="0" width="100%" height="100%">
							<tr>
								<td align="center" valign="middle">
									<a href="matt_hawn.php"><img src="../../images/meet_soldier/hawn/hawn_home.jpg" width="204" height="184" border="0"/></a>								</td>
							</tr>
						</table>
					</td>
				<td width="59">&nbsp;</td>
				<td class="content_box" width="244" height="220">
						<table cellpadding="0" border="0" cellspacing="0" width="100%" height="100%">
							<tr>
								<td align="center" valign="middle">
									<a href="julie_outlaw.php"><img src="../../images/meet_soldier/outlaw/outlaw_home.jpg" width="204" height="184" border="0"/></a>								</td>
							</tr>
						</table>
					</td>
					<td width="59">&nbsp;</td>
