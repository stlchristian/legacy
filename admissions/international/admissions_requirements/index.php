				...
				<tr>
					<td>
						...
						<ul>
							...
							<li>Bank Letter from Supporter</li>
						</ul>
						<b>Requirements prior to enrollment</b>
						<ul>
							<li>Completed College Transcript(s)</li>
							<li>Health Form</li>
							<li>Housing Form (if living on campus)</li>
							<li>I-20 Shipping/Handling Fee ($100 non-refundable)</li>
						</ul>
						<b>Requirements prior to semester start</b>
						<ul>
							<li>Visa</li>
