	  ...
	  <td rowspan="2" class="content">
		  <table width="795" border="0" cellpadding="0" cellspacing="0" class="table_valign_content">
			...
			<tr>
				...
				<!-- InstanceBeginEditable name="Main" --><table border="0" cellpadding="0" cellspacing="0" width="533">
				<tr valign="top">
					<td width="290" valign="top">
						<span class="style1">International</span>					  <br />
						<br />
				  International students provide a key element to the diversity of Saint Louis Christian College. We invite students from all countries to become a part of our growing student body. We are thrilled that you are considering Saint Louis Christian College to further your education. We look forward to meeting you!<br /><br />
                  <i>If you have would like more information about becoming an international student, please contact the Admissions Office at <a href="javascript:linkTo_UnCryptMailto('nbjmup;benjttjpotAtmddpomjof/fev');">admissions [at] slcconline [dot] edu</a> or 314.837.6777 x8110</i></td>
					<td width="10">&nbsp;</td>
					<td width="233" valign="middle"><div align="center"><img src="../../images/admissions/gerson.jpg" border="0" /></div></td>
				</tr>
