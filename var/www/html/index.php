								...
								<center>
								  <div class="centerdiv">
									<script type="text/javascript">
										...
										new fadeshow(fadeimages, 204, 184, 0, 7000, 0)
									</script>
								  </div>
								</center>
								</td>
							...
							<tr>
								...
								<td width="194" height="446" valign="top">
								  ...
								  <p>
									...
									athletics_sched();
									?>  
									  <a href="../../../athletics/calendar">Click here for future athletic events.</a><br /><a href="../../../downloads/Chapel_speakers_and_Presiders_SP11.pdf" target="_blank">Click here for the Chapel Schedule.</a></p>
							  </td>
								<td width="25" height="446">&nbsp;</td>
							</tr>
							<tr>
						...
						<table cellpadding="0" border="0" cellspacing="0" width="100%" height="100%">
							<tr>
								<td align="center" valign="middle">
									<a href="../../../admissions/apply"><img src="../../../images/applyonline.jpg" width="204" height="184" border="0"/></a>								</td>
							</tr>
						</table>
					</td>
