				...
				<td valign="top">
					<table width="142" cellpadding="0" cellspacing="0" border="0" class="table_valign_content">
						...
						<tr>
							...
							<td width="110"><center>
								<a href="../athletics/womens_crosscountry/meet_the_coach/"><b>Meet The Coach</b></a>
								<br />
								<br />
								<a href="../athletics/womens_crosscountry/meet_the_lady_soldiers/"><b>Meet The<br />
							  Lady Soldiers</b></a>
								<br />
								<br />
								<a href="../athletics/womens_crosscountry/schedule/"><b>Schedule</b></a>
								<br />
								<br />
								</center>
							</td>
