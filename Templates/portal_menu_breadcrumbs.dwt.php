					...
					<table cellpadding="0" cellspacing="0" border="0" width="120">
						<tr>
							<td width="120" align="left">
								<?php if ($_SESSION['login']==1) include ("../portal/includes/menu.inc.php");?>
							</td>
						</tr>
					</table>
				</td>
				<td valign="top" colspan="2">
					<table height="16" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td width="25">&nbsp;</td>
							<?php if ($_SESSION['login']==1){?><td align="right"><a href="../portal/?logout=1">Logout</a></td><?php } ?>
						</tr>
					</table>
				</td>
			</tr>
			<tr>
				<td valign="top">
					<table cellpadding="0" cellspacing="0" border="0">
					  <tr>
						<td width="10">&nbsp;</td>
						<?php include_once("../portal/includes/submenu.inc.php");?>
					  </tr>
					 </table>
				</td>
				<td valign="top">
					<table border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td width="665"><!-- TemplateBeginEditable name="Main" --><!-- TemplateEndEditable --> </td>
						</tr>
					</table>
				</td>
			</tr>
