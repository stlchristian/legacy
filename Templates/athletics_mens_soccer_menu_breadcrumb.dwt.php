				...
				<td valign="top">
					<table width="142" height="100%" cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							...
							<td width="110"><center>
								<a href="../athletics/mens_soccer/meet_the_coach/"><b>Meet The Coach</b></a>
								<br />
								<br />
								<a href="../athletics/mens_soccer/meet_the_soldiers/"><b>Meet The<br />Soldiers</b></a>
								<br />
								<br />
								<a href="../athletics/mens_soccer/schedule/"><b>Schedule</b></a>
								<br />
								<br />
								</center>
							</td>
