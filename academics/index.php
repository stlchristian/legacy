...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/academics_menu_breadcrumb.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
...
<title>Academics | Saint Louis Christian College</title>
<!-- InstanceEndEditable -->
	  ...
	  <td rowspan="2" class="content">
	  	<table border="0" cellpadding="0" cellspacing="0">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="665">
				<tr>
					<td width="300">At Saint        Louis Christian College we are committed to developing in students relational ministry      skills as well as academic excellence. Our small class sizes      allow you to get to know your professors on a deeper level. The ministry expertise of faculty      assures that you are getting the education needed to go beyond the walls of      Saint Louis Christian College      and the limits of your own experience. &nbsp;Through our Ministry      Advancement Program (MAP), which      is an academic requirement for all SLCC students, we also      provide many opportunities for students to work alongside faculty and staff      outside of the classroom for ministry, community service, mission trips and      more.&nbsp; The relationships SLCC students cultivate with their professors continue long      after graduation.</td>
					<td width="10">&nbsp;</td>
					<td width="355" valign="middle"><img src="../images/academics/andrew_book.jpg" border="0" /></td>
				</tr>
			</table>
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td colspan="3" height="25"><img src="../images/grayline_contentdivider.jpg" width="665" /></td>
				</tr>
			</table>
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td width="300" rowspan="3" valign="middle"><img src="../images/academics/brown.jpg" border="0" /></td>
					<td width="10">&nbsp;</td>
					<td width="350">
						<font class="section_heading">Degree Programs</font>
						<br />
						Saint Louis Christian College is a four-year Bible College that offers a variety of degree programs.
						<br />
						<br />
						<a href="degree_programs/"> <strong>Click here to view Saint Louis Christian College's Degree Programs</strong> </a> 
					</td>
					<td width="5">&nbsp;</td>
				</tr>
				<tr>
					<td width="10">&nbsp;</td>
					<td height="25" colspan="2"><img src="../images/grayline_contentdivider.jpg" width="355" /></td>
				</tr>
				<tr>
					<td width="10">&nbsp;</td>
					<td width="350">
						<?php include("includes/academics.inc"); ?>
						<a href="partnership_programs/"> <strong> Click here to view the partnership programs Saint Louis Christian College has with other universities. </strong> </a>
						<br />
						<br />
					</td>
					<td width="5">&nbsp;</td>
