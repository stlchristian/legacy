...
<title>Academic Catalog | Saint Louis Christian College</title>
<!-- InstanceEndEditable -->
	...
	<tr>
	  ...
	  <td rowspan="2" class="content">
	  	<table border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
			  <td valign="top" colspan="4">The Saint Louis Christian College Academic Catalog is available to view and print in a PDF format.<br />
			    <br /></td>
			</tr>
			<tr>
				<td valign="top" width="190"><?php include("../../includes/catalog.inc"); ?></td>
				<td width="35">&nbsp;</td>
				<td valign="top" width="300">
					<a href="pdf/guide_to_student_life.pdf"><font class="section_heading">Guide To Student Life</font></a> (PDF)
					<br />The Guide to Student Life is the official student handbook for SLCC students. It includes campus life information, lifestyle expectations, disciplinary guidelines, the student government constitution, a directory of personnel, and other information helpful to current and  prospective stuents. Click <a href="pdf/guide_to_student_life.pdf">here</a> to download the Guide To Student Life.
				</td>
				<td width="140">&nbsp;</td>
			</tr>
		</table>
